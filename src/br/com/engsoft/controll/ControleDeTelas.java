...
public class ControleDeTelas {
    ...
    public void abrirGuicheA(javax.swing.JFrame f, String titulo, String atendente) {
        try {
            TelaGuicheA ga = new TelaGuicheA();
            ga.setVisible(true);
            f.setVisible(false);
            ga.lblTitulo.setText(titulo);
    ...
    public void abrirGuicheDefault(javax.swing.JFrame f, String titulo, String atendente, String guiche) throws InterruptedException {
        TelaGuichePadrao gp = new TelaGuichePadrao();
        gp.setVisible(true);
        f.setVisible(false);
        if (guiche.contains("D")) {
    ...
    public void getOperacoesPermitidas(TelaModulos at, UsuarioModelo m) {
        ...
        if (m.getGuicheA() == 'S') {
            ...
            at.cbbGuicheA.setEnabled(true);
        }
        if (m.getGuicheB() == 'S') {
            at.rbtnGuicheB.setEnabled(true);
            at.cbbGuicheB.setEnabled(true);
        }
        if (m.getGuicheC() == 'S') {
            at.rbtnGuicheC.setEnabled(true);
            at.cbbGuicheC.setEnabled(true);
        }
        if (m.getGuicheD() == 'S') {
            at.rbtnGuicheD.setEnabled(true);
            at.cbbGuicheD.setEnabled(true);
        }
    }
